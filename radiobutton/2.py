...
class Aplicacion:
    def __init__(self):
        ...
        self.radio2=tk.Radiobutton(self.ventana1,text="Multiplicar", variable=self.seleccion, value=3)
        self.radio2.grid(column=1, row=4)
        self.radio2=tk.Radiobutton(self.ventana1,text="Dividir", variable=self.seleccion, value=4)
